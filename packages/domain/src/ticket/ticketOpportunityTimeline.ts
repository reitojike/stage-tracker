...
/**
 * TicketOpportunity timeline calculation. The implementation is standalone;
 * the product rules are defined by the current specs below.
 *
 ...
 * that boundary day itself) - the seven-day post-final retention semantic is
 * owned by Spec 008. `TICKET_POST_FINAL_RETENTION_DAYS` is this module's
