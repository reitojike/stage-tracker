...
/**
 * Genre: a canonical lookup row, not a closed DB enum (`specs/011-catalog-classification-filter/spec.md`
 * "Genre" / "Gate A"). Gate A ships exactly 3 seed rows (宝塚/歌舞伎/アイドル), but
