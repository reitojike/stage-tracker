...
- Initial rollout preference (2026-09-23): Kabuki Event first, weekly. Its
  ...
  and may supply a final-act end for each matching opening clock only when its
  parts, clock sequence, and footer are completely recognized on a page without
  a daily calendar. Unknown layouts
