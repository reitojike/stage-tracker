...
export default [
  {
    ignores: [
      ...
      // TS program.
      'supabase/.temp/**',
      // Vendored design handoff artifacts copied verbatim from outside the
      // repo (Claude Design canvases and their support.js runtime); see
      // docs/design/README.md. Not hand-authored source and not part of
      // the product's TS program, so they are outside the quality profile.
      'docs/design/**',
