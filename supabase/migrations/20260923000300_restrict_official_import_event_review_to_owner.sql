-- A designated catalog creator may review candidates, but designation does
-- not grant the ability to update another creator's Event. Keep the approved
-- candidate's reviewer aligned with the existing Event owner before the
-- trusted apply workflow uses that reviewer as its import owner.
--
