...
/**
 * `/catalog` route is runtime-owned. Event catalog semantics follow Spec 005;
 * classification/filter semantics follow Spec 011. Read-only - no
 ...
 * re-deriving it: this runtime's malformed-value fallback and
