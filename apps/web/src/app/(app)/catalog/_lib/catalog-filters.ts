...
/**
 * Client-local catalog filter state (`specs/005-event-occurrence-lifecycle/spec.md`
 * 「イベントカタログ一覧」, specs/011-catalog-classification-filter/spec.md "Catalog classification / venue
...
/**
 * group/venue option は genre ごとにスコープする（specs/011-catalog-classification-filter/spec.md「Group」:
...
/** The 1 secondary facet active for a given genre (specs/011-catalog-classification-filter/spec.md "Facet model
 ...
 * (specs/011-catalog-classification-filter/spec.md "Filter semantics": "何も選択していない場合と...全選択している
 ...
 *
 * A `Group`'s canonical identity is genre-independent (specs/011-catalog-classification-filter/spec.md "Group":
 ...
 * with a group but *no* genre (classification-wise possible per specs/011-catalog-classification-filter/spec.md
