 ...
 * catalog-wide group *filter* already worked. specs/011-catalog-classification-filter/spec.md "Catalog
 ...
 * (0..N per specs/011-catalog-classification-filter/spec.md "Group": "Event と group の関連は 0..N"), joined into
