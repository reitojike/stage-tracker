 ...
 * "planning state 変更" per-row buttons) are rendered too. This exact
 * per-row control presentation is runtime-owned; the M8 note records
 * historical provenance for the correction. Rendered once per Opportunity via
