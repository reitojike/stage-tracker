...
/**
 * `/tickets`'s presentational layer (`specs/008-ticket-opportunity-planning/spec.md`
 ...
 * while the component only applies the current contract presentation priority.
 *
 ...
 *
 * Planning-state controls (`TicketOpportunityStateControls`, the current contract's
...
/**
 * Badge priority (the current contract 「チケット一覧」): effective cancellation
    ...
    <ListRow>
      ...
      <div className="min-w-0 flex-1">
        ...
        {/* Opportunity につき1回だけ（`isFirstRowForOpportunity`）。ボタンを
          ...
          非表示にする（`specs/008-ticket-opportunity-planning/spec.md`「チケット一覧」;
