...
/**
 * `blocking` に per-recipient override が無いこと（Spec 012 PSH-016 の
 * sharing boundary: 各 entry は独立した blocking boolean を持ちます。
 * per-recipient の blocking override は設けません）を、この画面の実際の表示コンポーネントで
