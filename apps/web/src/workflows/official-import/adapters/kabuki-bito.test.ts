...
describe("Kabuki-bito adapter facts", () => {
  ...
  it("rejects an unverified schedule-changing calendar footnote", () => {
    const table = mobileCalendar("<th></th><th>第一部</th><th>第二部</th>", [
      "<th>1（木）</th><td>11：00</td><td>16：00</td>",
    ]);
    for (const suffix of [
      "※第二部 午後5時～に変更",
      "【休演・貸切】日程詳細をご確認ください ※第二部 午後5時～に変更",
    ]) {
      expect(() =>
        parseKabukiDetailedOccurrences(
          table,
