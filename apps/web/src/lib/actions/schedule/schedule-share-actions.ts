 ...
 * （`specs/012-personal-schedule-sharing-privacy/spec.md` `addScheduleShareByEmailAction`）。
 *
 ...
 * action はそれを呼ぶだけ - `specs/012-personal-schedule-sharing-privacy/spec.md` の「各 action は
 * 権限判定を一切行わない」という設計をそのまま踏襲する。
 *
 * `email` の未登録は「知らせてよい」（specs/012-personal-schedule-sharing-privacy/spec.md
...
/**
 * 非owner の自己離脱（`specs/012-personal-schedule-sharing-privacy/spec.md`
 ...
 * 対象にする」不変条件が成立する。
 *
 * 成功時は `/calendar` へ redirect（`specs/012-personal-schedule-sharing-privacy/spec.md`
