...
/**
 * `/mypage` の Passkey deletion is an account credential operation under Spec 009;
 * the Server Action/API wiring is runtime-owned.
 ...
 * 直接呼ぶ（browser/runtime mechanism）。
 *
