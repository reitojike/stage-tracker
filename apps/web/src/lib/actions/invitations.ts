...
/**
 * Accept: Spec 006 Invitation coordination semantics. Runtime/DB
 * implementation reuses the normal Participation write and has no dedicated
 * accept RPC. Acceptance uses the same operation（`considering`/rowなし ->
