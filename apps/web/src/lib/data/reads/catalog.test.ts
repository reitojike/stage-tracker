          ...
          [
            {
              ...
              // state (`specs/005-event-occurrence-lifecycle/spec.md` "Event 開催期間 (Event range)").
              event_occurrences: [],
              genres: {
...
describe("listGroupsByIds", () => {
   ...
   * associate される group 数の上限が無い - specs/011-catalog-classification-filter/spec.md「Group」）が
