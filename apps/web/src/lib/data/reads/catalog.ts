 ...
 * Event range semantics follow Spec 005; `listEventCatalogInRange` and the
 * query/read mechanics are data-layer owned。
 *
 ...
 * グループとも数十件規模）だという現状の dataset scale、`.in("id", groupIds)` の
 * URL 長、query strategy は local data-layer assumptions/mechanics であり、問題になる規模には
