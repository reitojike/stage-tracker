...
// Issue #359: `.badgeRow` is now a shared role (ui/listRow.module.css) that
// bundles the badges layout with the top-margin this screen and Home's own
// upcoming list both need - its own contract and wiring guard live in
// src/ui/__tests__/listRow.test.ts, not here.
