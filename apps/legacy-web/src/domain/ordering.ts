...
// invitation, personal schedule, and TicketOpportunity needs the same shape
// of comparator: order by one comparable
...
// exists so those feature call sites share one implementation instead of
// each re-deriving it.
//
