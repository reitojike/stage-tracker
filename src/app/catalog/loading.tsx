 ...
 * real page commits. This screen has no action row of its own ("+ 追加" /
 * "招待一覧" are reachable through My Page's own "予定とイベント" section),
 * so this fallback has nothing else to restate.
 */
